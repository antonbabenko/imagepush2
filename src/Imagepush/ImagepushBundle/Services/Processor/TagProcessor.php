...
class TagProcessor extends HtmlContent
{
   ...
   * @services
   */
  public $kernel, $tagsManager, $redis;

  public function __construct(\AppKernel $kernel)
  {
    $this->kernel = $kernel;
    $this->tagsManager = $this->kernel->getContainer()->get('imagepush.tags.manager');
    $this->redis = $this->kernel->getContainer()->get('snc_redis.default_client');
  }
  ...
  public function processTags()
  {
    ...
    if (count($this->image->sourceTags)) {
      $sourceTags = $this->tagsManager->getHumanTags($this->image->sourceTags);
    } else {
      $sourceTags = array();
    }
